...
INSERT INTO `equipment` VALUES (1,'Удлинитель',1,1),(2,'Удлинитель',2,1),(3,'Паяльник',1,1),(4,'Отвертка',1,1),(5,'Стриппер',2,1),(6,'Разводной ключ',2,1),(7,'Рулетка',2,1),(8,'Ножницы',1,1),(9,'Компрессор',2,1),(10,'Перфоратор',1,1),(11,'Перфоратор',2,3),(12,'Ножницы',3,1),(13,'Пилка для ногтей',3,4),(14,'Паяльник',2,1),(15,'Удлинитель',3,3),(16,'Нарядные платья',1,1);
...
INSERT INTO `subdivisions` VALUES (1,'Электрики','Делают проводку'),(2,'Монтажники','Монтирует'),(3,'Парикмахеры','Делают прически');
...
-- Dump completed on 2020-10-26 22:59:55
